...
Challenges = '{"environments": ["Fesbuc","Tweepy"], "challenges": ["base64","caesarcipher"]}'

json_unitnew = json.loads(Challenges)

print(json_unitnew['environments'])
print(json_unitnew['challenges'])
